...
export const metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: 'Aashrith Racherla | AI & Full-Stack Engineer',
    template: '%s | Aashrith Racherla',
  },
  description:
    'AI & Full-Stack Engineer specializing in LLM development, agentic AI systems, and scalable web applications. MS Computer Science, CSULB. Open to hybrid & remote roles.',
  keywords: [
    'Aashrith Racherla',
    'AI Engineer',
    'Full Stack Developer',
  ...
  authors: [{ name: 'Aashrith Racherla', url: SITE_URL }],
  creator: 'Aashrith Racherla',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: SITE_URL,
    siteName: 'Aashrith Racherla',
    title: 'Aashrith Racherla | AI & Full-Stack Engineer',
    description:
      'AI & Full-Stack Engineer specializing in LLM development, agentic AI systems, and scalable web applications. MS Computer Science, CSULB. Open to hybrid & remote roles.',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Aashrith Racherla | AI & Full-Stack Engineer Portfolio',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              '@context': 'https://schema.org',
              '@type': 'Person',
              name: 'Aashrith Racherla',
              url: SITE_URL,
              email: 'aashrithracherla02@gmail.com',
              jobTitle: 'AI & Full-Stack Engineer',
              sameAs: [
                'https://github.com/Aashrith7',
                'https://linkedin.com/in/aashrith-r',
              ],
            }),
          }}
        />
